...
describe('FormatterEmitter', () => {
  ...
  it('calls the callback with my formatter when I register', () => {
    const unsubscriber = FormatterEmitter.register({
      value: 'any value',
  ...
  describe('with more than 1 subscription', () => {
    it('calls the callback when let 1 subscription active', () => {
      ...
      unsubscriber()
      const unsubscriber2 = FormatterEmitter.register({
        value: 'any value',
        formatter: differentFormatter,
        callback
      })
    ...
    it('clears interval when there is no subscribers', () => {
      ...
      const unsubscriber1 = FormatterEmitter.register({
        value: 'any value',
        formatter: differentFormatter,
        callback
      }, dependencies)
